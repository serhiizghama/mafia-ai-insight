...
class MlxWhisperBackend(BaseTranscriber):
    ...
    def transcribe(self, audio_path: str) -> List[Dict[str, any]]:
        ...
        # Mafia-specific context for better recognition of game terminology
        initial_prompt = (
            "Транскрипция игры в профессиональную Мафию (турнир). "
            "Роли и действия: Красный игрок (мирный), Черный игрок (мафия), Дон ищет Шерифа, Шериф ищет Мафию, Лжешериф, "
            "вскрытие, проверка, жесткая проверка, маяк, самострел, промах, договорка, отстрел, динамика, лучший ход. "
            "Голосование и логика: выставление кандидатуры, попил стола, слом стола, автокатастрофа, перестрелка, "
            "критический круг, угадайка, баланс, противовес, три в три, два в два, разноцвет, одноцвет, окраснение, очернение. "
            "Судейство: фол, удаление, победа города, победа мафии, судейское решение, баллы, коэффициент, компенсация, ППК (поговорил покинь). "
            "Фразы: я пас, выставляю игрока, забираю руку, речь, агуканье. Левша, 22."
        )
